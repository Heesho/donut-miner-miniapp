    ...
    <main className="flex h-screen w-screen justify-center overflow-hidden bg-black font-mono text-white">
      ...
      >
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <Card
            className={cn(
              "mt-3 border-zinc-800 bg-gradient-to-br from-zinc-950 to-black transition-shadow rounded-xl",
          ...
          <div className="mt-1 flex flex-col gap-1.5 pb-1">
            ...
            <Button
              className="w-full rounded-xl bg-pink-500 py-3 text-sm font-bold text-white shadow-lg transition-colors hover:bg-pink-400 disabled:cursor-not-allowed disabled:bg-pink-500/40"
              onClick={handleGlaze}
              disabled={isGlazeDisabled}
            >
              {buttonLabel}
